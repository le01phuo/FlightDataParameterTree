...
import sys, os
import flightdataparamtertree as pkg
...
latex_documents = [
  ('index', 'FlightDataParamterTree.tex', u'Flight Data Parameter Documentation',
...
texinfo_documents = [
  ('index', 'FlightDataParameterTree', u'Flight Data Parameter Tree Documentation',
   u'Flight Data Services Ltd', 'FlightDataParameterTree', 'One line description of project.',
   'Miscellaneous'),
]
