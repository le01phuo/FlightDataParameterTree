...
__description__ ='FlightDataParameterTree is a web application which runs on \
your computer to graphically display the dependency tree diagram used during \
processing of derived parameters by the FlightDataAnalyzer.'
...
__keywords__= ['flight', 'data', 'analyser', 'parameter', 'tree']
